...
namespace PruebaTreeListView
{
    ...
    public class Chequeo : INotifyPropertyChanged
    {
        ...
        public static List<Chequeo> ListaChequeos()
        {
            ...
            lista.Add(new Chequeo("El informe está cargado en Sitramed", Categoria.Informe, NivelDeAccion.Advertencia, null, true, true, true, true, true, true, true, true, true, true, true, true, false, null, null, null, null));

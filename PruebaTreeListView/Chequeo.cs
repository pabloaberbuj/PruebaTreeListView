...
namespace PruebaTreeListView
{
    ...
    public class Chequeo : INotifyPropertyChanged
    {
        ...
        public static List<Chequeo> ListaChequeos()
        {
            ...
            lista.Add(new Chequeo("Orientación arcos", Categoria.Planificacion, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoEclipse.OrientacionArcos), true, false, true, false, false, true, true, true, true, true, true, false, false, null, null, null, null));
            ...
            //lista.Add(new Chequeo("Todos los planes están calculados en la misma CT", Categoria.Planificacion, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoEclipse.PlanesEnMismaCT), true, false, false, false, false, false, false, false, false, false, false, false, true, null, null, null, null));
            ...
            lista.Add(new Chequeo("Revisar que coordenadas de Imager sean correctas", Categoria.SetUp, NivelDeAccion.Advertencia, null, false, true, true, true, true, true, true, false, false, false, false, false, false, null, true, false, null));
            ...
            lista.Add(new Chequeo("DRRs en Centro de datos", Categoria.SetUp, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodoChequeoArchivos.TieneImagenesDRRenCDD), true, true, true, true, true, false, false, false, false, false, false, false, false, null, null, null, null));
            lista.Add(new Chequeo("Cantidad de DRRs Correcta", Categoria.SetUp, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodoChequeoArchivos.NumeroDeImagenesCorrectas), true, true, true, true, true, false, false, false, false, false, false, false, false, null, null, null, null));
            ...
            lista.Add(new Chequeo("La DFP de ref en simulación coincide con Eclipse", Categoria.SetUp, NivelDeAccion.Advertencia, null, false, true, true, true, true, true, true, false, false, true, true, false, false, null, null, null, null));
            lista.Add(new Chequeo("Las DFP de iso en simulación coincide con Eclipse", Categoria.SetUp, NivelDeAccion.Advertencia, null, false, true, true, true, true, true, true, false, false, false, false, false, false, null, null, null, null));
            lista.Add(new Chequeo("El dibujo de posicionamiento coincide con lo escrito en la simulación", Categoria.SetUp, NivelDeAccion.Advertencia, null, false, true, true, true, true, true, true, true, true, true, true, false, false, null, false, false, false));
            lista.Add(new Chequeo("Los planes están schedulados secuencialmente/simultáneamente según corresponde", Categoria.SetUp, NivelDeAccion.Advertencia, null, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false));
            ...
            lista.Add(new Chequeo("Hay campos que pueden requerir lateralizar camilla", Categoria.Planificacion, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoEclipse.CamposQueRequierenLateralizar), true, true, false, false, true, false, false, false, false, false, false, false, false, null, null, null, null));

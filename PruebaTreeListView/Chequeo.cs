...
namespace PruebaTreeListView
{
    ...
    public class Chequeo
    {
        ...
        public static List<Chequeo> ListaChequeos()
        {
            ...
            lista.Add(new Chequeo("Imagenes agendadas según equipo y técnica", Categoria.SetUp, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoAria.ImagenesAgendadasSegunEquipo), true, true, true, true, true, true, true, false, false, true, true, false, false, false, true, false, ""));

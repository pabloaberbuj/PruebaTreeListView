...
namespace PruebaTreeListView
{
    ...
    public class Chequeo : INotifyPropertyChanged
    {
        ...
        public static List<Chequeo> ListaChequeos()
        {
            ...
            lista.Add(new Chequeo("Camilla correcta", Categoria.Planificacion, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoEclipse.CamillaCorrecta), true, true, true, false, true, true, true, true, true, true, true, false, false, false, null, null, null));
            ...
            lista.Add(new Chequeo("Tiene campos de setup", Categoria.SetUp, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoEclipse.TieneCamposSetUp), true, true, true, true, true, true, true, true, true, true, true, true, false, null, null, null, null));
            ...
            lista.Add(new Chequeo("Se midió plan QA Portal", Categoria.QA, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoAria.SeMidioPlanQA), true, false, false, false, true, true, true, false, true, false, true, false, false, null, null, false, null));
            ...
            lista.Add(new Chequeo("Tiene Bolus", Categoria.SetUp, NivelDeAccion.Advertencia, null, false, false, false, false, false, false, false, false, false, false, false, false, false, null, null, null, null));
            ...
            lista.Add(new Chequeo("CT tiene más de 400 cortes", Categoria.APF, NivelDeAccion.Advertencia, new MyStaticMethodInvoker(MetodosChequeoEclipse.CTTieneMasDe400Cortes), true, false, false, false, false, false, true, true, true, true, true, false, false, false, false, false, true));
            lista.Add(new Chequeo("Plan exportado a Exactrac", Categoria.APF, NivelDeAccion.Advertencia, null, false, false, false, false, false, false, true, true, true, true, true, false, false, false, false, false, true));

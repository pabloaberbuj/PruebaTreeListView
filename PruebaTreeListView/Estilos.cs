...
namespace PruebaTreeListView
{
    internal class Estilos
    {
        public static void definirEstilos(Document doc)
        {
            ...
            var textoCentroCursiva = doc.AddStyle("Texto Centro Cursiva", "Texto Centro");
            textoCentroCursiva.ParagraphFormat.Font.Italic= true;
            textoCentroCursiva.ParagraphFormat.SpaceAfter = 8;
            ...
            subtitulo.ParagraphFormat.Font.Size = 14;
        ...
        public static void formatearSeccion(Section seccion)
        {
            ...
            seccion.PageSetup.LeftMargin = 30;
            seccion.PageSetup.RightMargin = 30;
        }
        public static void formatearTabla(Table tabla)
        {
            ...
            tabla.Rows[0].Shading.Color = new Color(238, 236, 225);
